...
namespace Matrix.Tests
{
    public class MatrixTests
    {
        ...
        [Test]
        public void Constructor_WithCorrectData_ReturnCorrectWiDht()
        {
            int myCorrectWidth = 5;
            CoolMatrix matrix = new int[myCorrectWidth, 55];

            Assert.AreEqual(matrix.width, myCorrectWidth);
        }

        [Test]
        public void Constructor_WithCorrectData_ReturnCorrectHeight()
        {
            int myCorrectHeight = 7;
            CoolMatrix matrix = new int[77, myCorrectHeight];
        ...
        [Test]
        public void Transpose_Always_Transposes2DMatrix()
        {
            CoolMatrix matrix = new[,]
            {
                { 1, 2 },
